...
void *uspi_memset (void *pBuffer, int nValue, size_t_r nLength)
{
	char *p = (char *) pBuffer;
...
void *uspi_memcpy (void *pDest, const void *pSrc, size_t_r nLength)
{
	char *pd = (char *) pDest;
	char *ps = (char *) pSrc;
...
int uspi_memcmp (const void *pBuffer1, const void *pBuffer2, size_t_r nLength)
{
...
size_t_r uspi_strlen (const char *pString)
{
	size_t_r nResult = 0;
...
char *uspi_strncpy (char *pDest, const char *pSrc, size_t_r nMaxLen)
{
	char *pResult = pDest;
