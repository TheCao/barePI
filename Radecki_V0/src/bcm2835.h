...
// Defines for AUX registers
#define BCM2835_AUX_IRQ         0x0000
#define BCM2835_AUX_ENABLES     0x0004
#define BCM2835_AUX_MU_IO_REG   0x0040  
#define BCM2835_AUX_MU_IIR_REG  0x0044  
#define BCM2835_AUX_MU_IER_REG  0x0048  
...
extern "C" {
	...
	extern void bcm2835_aux_muart_init(void);

	extern void bcm2835_aux_muart_transfer(uint8_t value);

	extern void bcm2835_aux_muart_transfernb(char* tbuf);

	extern void bcm2835_aux_muart_transfer_hex(uint32_t value);
