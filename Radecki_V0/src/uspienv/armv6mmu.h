...
//
#ifndef _uspienv_armv6mmu_h
#define _uspienv_armv6mmu_h
...
PACKED TARMV6MMU_LEVEL1_COARSE_PAGE_TABLE_DESCRIPTOR;
...
PACKED TARMV6MMU_LEVEL2_EXT_SMALL_PAGE_DESCRIPTOR;
